...
| `cost` | int | 0+ | Вес приоритета, используемый при респавне/очистке. Почти все ванильные предметы используют 100, но некоторые используют более высокие значения (например, `Mag_SVD_10Rnd` использует 1000). |
