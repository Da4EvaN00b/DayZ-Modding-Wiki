...
Глобальные параметры, влияющие на всю экономику: количество зомби, количество животных, таймеры очистки, диапазоны повреждений лута, время респавна. Всего 30 параметров. Полный справочник см. в [Главе 9.4](04-loot-economy.md).
...
```
storage_1/
  players/           # Двоичные записи персонажей, по одной на игрока
...
**Никогда не редактируйте вручную файлы в `players/` при работающем сервере.** Это непрозрачные двоичные записи, создаваемые только процессом сервера. Если вам нужно сбросить персонажей, сначала остановите сервер и удалите или переименуйте папку.
...
1. Остановите сервер
2. Удалите файлы в `storage_1/data/`, но сохраните `storage_1/players/`
3. Перезапустите
