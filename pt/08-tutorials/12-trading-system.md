...
modded class MissionGameplay
{
    ...
    // Chamado a partir do override DayZGame.OnRPC abaixo. MissionGameplay não tem OnRPC próprio.
...
// OnRPC(PlayerIdentity, Object, int, ParamsReadContext) vive em DayZGame, não na hierarquia
// Mission. O servidor envia com target=player, então DayZGame encaminha target.OnRPC para PlayerBase;
// para alcançar o menu do cliente, fazemos hook em DayZGame diretamente e roteamos para a mission.
