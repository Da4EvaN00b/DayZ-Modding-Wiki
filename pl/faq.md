...
**A:** Uzyj dyrektyw preprocesora `#ifdef SERVER` i `#ifndef SERVER` dla kodu, ktory musi dzialac tylko po jednej stronie. Dla wiekszych modow podziel je na oddzielne PBO: mod kliencki (UI, renderowanie, lokalne efekty) i mod serwerowy (spawnowanie, logika, persistencja). Zapobiega to wyciekowi logiki serwerowej do klientow. Zobacz [Rozdzial 2.5](02-mod-structure/05-file-organization.md) i [Rozdzial 6.9](06-engine-api/09-networking.md).
