...
modded class MissionGameplay
{
    ...
    // A lenti DayZGame.OnRPC override hívja meg. A MissionGameplay-nek nincs saját OnRPC-je.
...
// Az OnRPC(PlayerIdentity, Object, int, ParamsReadContext) a DayZGame-en él, nem a Mission
// hierarchián. A szerver target=player címzéssel küld, így a DayZGame továbbítja a target.OnRPC-t a PlayerBase-nek;
// a kliens menü eléréséhez közvetlenül a DayZGame-be horgozunk be, és átirányítjuk a missionhöz.
