...
modded class MissionGameplay
{
    ...
    // Chiamata dall'override DayZGame.OnRPC qui sotto. MissionGameplay non ha un proprio OnRPC.
...
// OnRPC(PlayerIdentity, Object, int, ParamsReadContext) risiede su DayZGame, non sulla gerarchia
// Mission. Il server invia con target=player, quindi DayZGame inoltra target.OnRPC a PlayerBase;
// per raggiungere il menu del client agganciamo DayZGame direttamente e instradiamo verso la mission.
