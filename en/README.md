<!-- GENERATED MIRROR of index.md — do not edit this file by hand. Edit en/index.md and re-sync; every chapter "Home" link across all 12 locales targets README.md, so this file must exist and match index.md. -->
