...
modded class MissionGameplay
{
    ...
    // Voláno z override DayZGame.OnRPC níže. MissionGameplay nemá vlastní OnRPC.
...
// OnRPC(PlayerIdentity, Object, int, ParamsReadContext) je na DayZGame, ne na hierarchii
// Mission. Server odesílá s target=player, takže DayZGame přeposílá target.OnRPC do PlayerBase;
// abychom se dostali do klientského menu, napojíme se přímo na DayZGame a směrujeme do mise.
