...
```cpp
protocol = 1;
publishedid = 2900000000;            // ID del elemento de Steam Workshop
name = "My Mod";                     // Nombre del elemento de Workshop
timestamp = 5249975085759540888;     // Valor interno de 64 bits, NO una marca de tiempo Unix
```
