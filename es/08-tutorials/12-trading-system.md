...
modded class MissionGameplay
{
    ...
    // Llamado desde la sobrescritura de DayZGame.OnRPC de abajo. MissionGameplay no tiene su propio OnRPC.
...
// OnRPC(PlayerIdentity, Object, int, ParamsReadContext) reside en DayZGame, no en la jerarquía
// de Mission. El servidor envía con target=player, por lo que DayZGame reenvía target.OnRPC a PlayerBase;
// para llegar al menú del cliente enganchamos DayZGame directamente y enrutamos a la misión.
